...
export const getAllEmployee = async (req, res) => {
    ...
    if (!req.employee) return res.status(404).json({ message: 'you have to login first to view this information'});

    try{
        // console.log(req.employee);
        const company = await Company.findById(req.employee.company).populate('employees');
